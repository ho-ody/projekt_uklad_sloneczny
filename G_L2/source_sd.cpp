...
int main() {
	...
	//n_verticles_to_draw--; //zmiejszenie iloœæ wierzcho³ków, które zostan¹ narysowane o 1,
						   //idealnie jeden z trójk¹tów nie powinien zostaæ narysowany
	/*
	GLfloat vertices[] = {
		-0.5f,-0.5f,1.0f,0.0f,0.0f,
		+0.5f,-0.5f,0.0f,1.0f,0.0f,
	...
	*/
	...
	{		
		...
		// za³aduj przygotowane wierzcho³ki
		glBufferData(GL_ARRAY_BUFFER, sizeof(GLfloat) * (size + 1) * (size + 1) * 5, vertices, GL_STATIC_DRAW);
		//colorUpdate(abs(a - 1), abs(b - 1), abs(c - 1), size, vertices);
